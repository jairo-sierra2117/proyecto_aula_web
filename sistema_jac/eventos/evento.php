...
<header class="header-area header-sticky">
  ...
  <main>
    ...
    <div class="row g-5">
      ...
      <form method="post">
        <h4 class="mb-3">INSCRIPCION EVENTOS</h4>
    ...
    <option value="">Seleccione el evento</option>
     ...
     <option value="<?php echo $opciones['evento']?>"><?php echo $opciones['evento']?></option>
     ...
     <?php endforeach ?>
      ...
      <div class="col-12">
        ...
        <textarea type="text" class="form-control" id="comentarios" rows="5" cols="30" name="comentarios"></textarea>

        <div class="resume-section-content"><p></p></div>  
      </div>
        <input type="submit" name="enviar" class="btn btn-primary btn-lg">
        <input type="reset" name="limpiar" class="btn btn-primary btn-lg">
