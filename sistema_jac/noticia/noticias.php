...
<html>
<head>
    <title>Inscribirse a un vento</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/estilo_Even.css">
<!--
...
<body>
  <div class="navbar"><span class="welcome-text">Bienvenido(a)</span>
    ...
    <ul>
      ...
      <li><a href="../noticia/ListadoNoti.php">Listado de noticias</a></li>
    </ul>
  </div>
</body>
</html>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="bibliografia" class="form-label">Bibliografía <span class="text-body-secondary">(Opcional)</span></label>
              <input type="text" class="form-control" id="bibliografia" placeholder="" name="bibliografia">
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="fecha" placeholder=""name="fecha">
              <div class="invalid-feedback">
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="hora" placeholder=""name="hora">
              <div class="invalid-feedback">
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="num_celular" placeholder="" name="num_celular">
              <div class="invalid-feedback">
              </div>
            </div>
          ...
          <input type="submit" name="enviar" class="btn btn-primary btn-lg">
