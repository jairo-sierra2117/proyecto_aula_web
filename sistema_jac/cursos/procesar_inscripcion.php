...
<html>
<head>
    <title>Registrarse a un curso</title>
    <meta charset="utf-8">
    ...
    <div class="containerr">
        <form action="procesar_registro.php" method="POST">
            ...
            <select id="curso" name="curso" required>
                ...
                // Consulta para obtener los nombres de los cursos desde la base de datos
                $consulta = mysqli_query($conex, "SELECT nombre FROM datos");

                // Generar las opciones del campo de selección con los nombres de los cursos
