      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li><a href="Login_y_registro/index_login.php" class="bg-gradient bg-opacity-25">Login</a></li>
              <li class="scroll-to-section"><a href="#top" class="active">Inicio</a></li>
              <li class="scroll-to-section"><a href="#services">Eventos</a></li>
              <li><a href="cursos/prueba1.php">Cursos</a></li>
              ...
              <li class="has-sub">
                ...
                <ul class="sub-menu">
                  ...
                  <li><a href="eventos/evento.php">Inscribirme en eventos</a></li>
                </ul>
              </li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            ...
            <div class="main-button-gradient">
              <a href="eventos/Eventosdisponibles.php"> Ver eventos disponibles </a>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <div class="text-button">
                            <a href="cursos\prueba1.php">Inscribete al curso</a>
                          </div>
                        </div>
                      </div>
                    </li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            ...
            <div class="main-button-gradient">
              <div class="main-button-gradient">
                <a href="noticia/ver_noti.php"> Ver Noticias </a>
              </div>
            </div>
          </div>
        </div>
