      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            <h6>YESMITH ADRIANA ROSAS CAICEDO </h6>
            <h2>JUNTA DE ACCION COMUNAL<em> PATIOS CENTRO</em></h2>
        ...
        <div class="col-lg-6">
          <div class="right-image">
            <img src="assets/images/Logo_01.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="owl-service-item owl-carousel">
            <div class="item">
              <div class="service-item">
                ...
                <h4>Ferias de salud</h4>
                <p>Estos eventos son ideales para promover la salud y el bienestar en el barrio. Puedes invitar a profesionales de la salud para que brinden charlas informativas, realicen pruebas gratuitas y ofrezcan consejos para llevar una vida más saludable..</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
                ...
                <p>Puedes organizar torneos de fútbol, baloncesto, voleibol, entre otros, para fomentar el deporte y la actividad física en el barrio. También puedes ofrecer clases gratuitas de yoga, pilates u otras disciplinas.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
                ...
                <h4>Festivales culturales</h4>
                <p>Si quieres promover la cultura y la diversidad en tu barrio, puedes organizar festivales que celebren las tradiciones y costumbres de diferentes países o regiones. Puedes incluir música, danza, comida y artesanías típicas.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
                ...
                <h4>Eventos solidarios</h4>
                <p>Puedes organizar eventos para recaudar fondos y promover la solidaridad en el barrio, como construir un centro comunitario, apoyar a familias vulnerables o proteger el medio ambiente.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            ...
            <p>Aquí te dejo algunos ejemplos de cursos que podrías incluir para apoyar a las juntas de acción comunal.</p>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="naccs">
            <div class="tabs">
              <div class="row">
                <div class="col-lg-3">
                  <div class="menu">
                    <div class="active gradient-border"><span>Informática básica</span></div>
                    <div class="gradient-border"><span>Artes y manualidades</span></div>
                    <div class="gradient-border"><span>Cocina</span></div>
                    <div class="gradient-border"><span>Desarrollo personal</span></div>
                  </div>
                </div>
                <div class="col-lg-9">
                  <ul class="nacc">
                    <li class="active">
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p> Este curso puede enseñar habilidades básicas de informática <a rel="nofollow" href="#" target="_blank">Sitio del curso </a>como el uso de programas de procesamiento de texto, navegación en internet y correo electrónico.</p>
                          <span>36 Horas</span>
                          <span>4 Semanas</span>
                          <span class="last-span">3 Certificado</span>
                          <div class="text-button">
                            <a href="curso.html">Inscribete al curso</a>
                          </div>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p> Los cursos de artes y manualidades pueden enseñar habilidades como pintura, dibujo, escultura, bordado, costura, entre otras.<br></p>
                          <span>48 Horas</span>
                          <span>6 Semanas</span>
                    ...
                    <li>
                      <div>
                        ...
                        <div class="right-content">
                          <h4>Cocina</h4>
                          <p>Los cursos de cocina pueden enseñar a preparar comidas saludables, económicas y deliciosas. Puedes enfocarte en cocina local, internacional o vegetariana.</p>
                          <span>28 Horas</span>
                          <span>4 Semanas</span>
                          <span class="last-span">1 Certificado</span>
                          <div class="text-button">
                    ...
                    <li>
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p>Los cursos de desarrollo personal pueden enseñar habilidades como la gestión del tiempo, la resolución de conflictos, la comunicación efectiva, entre otras.</p>
                          <span>48 Horas</span>
                          <span>4 Semanas</span>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  <h6>Contactanos</h6>
                  <h4>Di <em>hola</em></h4>
                  <p>Para cualquier preguta, queja, reclamo o solicitud, envianos un mensaje o llamanos a nuestras lineas de atencion.</p>
                </div>
              </div>
              <div class="col-lg-12">
                <fieldset>
