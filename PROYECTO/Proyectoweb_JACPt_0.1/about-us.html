      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <div class="section-heading">
            <h6>Conseguir información</h6>
            <h4>Leer mas <em>sobre nosotros</em></h4>
            <p>Somos una plataforma dedicada a brindar apoyo a las juntas de acción comunal de cualquier barrio, fomentando la participación ciudadana y el desarrollo comunitario a través de la promoción de eventos, cursos y servicios en nuestro portal. Nuestra <strong>visión</strong> es construir comunidades más unidas y solidarias, donde cada persona tenga la oportunidad de crecer y desarrollarse en un ambiente seguro y acogedor.

              <br><br>En nuestro portal encontrarás noticias, eventos, cursos y un sistema PQRS para estar al día con las actividades de la junta de acción comunal de tu barrio. Además, ofrecemos herramientas y recursos para ayudarte a planificar y organizar eventos y actividades para la comunidad. Si quieres unirte a nosotros y ser parte del cambio en tu barrio, ¡contáctanos hoy mismo!</p>
          </div>
          <div class="row">
            <div class="col-lg-6">
              <div class="info-item">
                ...
                <h4>Estrategia</h4>
                <p> Una vez que tengas tu sitio web en funcionamiento, promociónalo a través de las redes sociales.</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-item">
                ...
                <h4>Ideas</h4>
                <p>Realiza un seguimiento regular de los resultados de tu sitio web.</p>
              </div>
            </div>
          </div>
        </div>
